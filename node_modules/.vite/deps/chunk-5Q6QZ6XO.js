...
var TableCell = React10.forwardRef(function TableCell2(inProps, ref) {
  ...
  return (0, import_jsx_runtime11.jsx)(TableCellRoot, _extends({
    as: component,
    ref,
    className: clsx_default(classes.root, className),
    "aria-sort": ariaSort,
...
true ? TableCell.propTypes = {
   ...
   */
  variant: import_prop_types7.default.oneOfType([import_prop_types7.default.oneOf(["body", "footer", "head"]), import_prop_types7.default.string])
} : void 0;
...
var Toolbar = React11.forwardRef(function Toolbar2(inProps, ref) {
  ...
  return (0, import_jsx_runtime12.jsx)(ToolbarRoot, _extends({
    as: component,
    className: clsx_default(classes.root, className),
    ref,
    ownerState
...
true ? Toolbar.propTypes = {
   ...
   * @default 'regular'
   */
  variant: import_prop_types8.default.oneOfType([import_prop_types8.default.oneOf(["dense", "regular"]), import_prop_types8.default.string])
} : void 0;
...
var _excluded7 = ["backIconButtonProps", "count", "disabled", "getItemAriaLabel", "nextIconButtonProps", "onPageChange", "page", "rowsPerPage", "showFirstButton", "showLastButton", "slots", "slotProps"];
...
var _InputBase;
var _excluded8 = ["ActionsComponent", "backIconButtonProps", "className", "colSpan", "component", "count", "disabled", "getItemAriaLabel", "labelDisplayedRows", "labelRowsPerPage", "nextIconButtonProps", "onPageChange", "onRowsPerPageChange", "page", "rowsPerPage", "rowsPerPageOptions", "SelectProps", "showFirstButton", "showLastButton", "slotProps", "slots"];
...
//# sourceMappingURL=chunk-5Q6QZ6XO.js.map
